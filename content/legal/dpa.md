...
OPERADORA: VETOR AUTOMAÇÃO EMPRESARIAL LTDA, CNPJ 65.473.700/0001-49, com sede na Rua General Góes Monteiro, nº 456, Apto. 901, Bairro São Francisco, Bento Gonçalves/RS, CEP 95.703-052 (“VETOR” ou “OPERADORA”).

CONTROLADOR: o CLIENTE qualificado no contrato de prestação de serviços ao qual este Acordo se vincula (“CONTROLADOR”).
...
**1.2.** As partes reconhecem que, quanto aos dados dos Leads, o CONTROLADOR é o controlador e a VETOR é a operadora, tratando os dados exclusivamente em nome e segundo as instruções documentadas do CONTROLADOR.
...
**2.2.** Dispor de base legal válida (art. 7º ou art. 11 da LGPD) para o tratamento dos dados dos Leads e, quando aplicável, obter e comprovar o consentimento dos titulares.

**2.3.** Garantir que possui o direito de coletar e transmitir os dados à VETOR e que a base de contatos foi obtida de forma lícita.
...
**3.2.** Não utilizar os dados dos Leads para finalidades próprias diversas das contratadas, ressalvado o uso técnico, agregado ou anonimizado, necessário ao funcionamento, à segurança e à melhoria do serviço.

**3.3.** Garantir que pessoas autorizadas a tratar os dados estejam sujeitas a dever de confidencialidade.

**3.4.** Adotar medidas de segurança técnicas e administrativas razoáveis e compatíveis com o estado da técnica (Cláusula 5).

**3.5.** Auxiliar o CONTROLADOR, na medida de seu papel de operadora e mediante eventual remuneração de custos razoáveis, no atendimento a solicitações de titulares e a requisições de autoridades.

**3.6.** Informar o CONTROLADOR, sem demora injustificada, sobre incidentes de segurança de que tenha conhecimento (Cláusula 6).
...
**4.2.** A VETOR adotará diligência razoável na seleção de suboperadores e lhes imporá deveres de proteção de dados compatíveis com este DPA, na medida do contratualmente viável. A VETOR responde nos limites da Cláusula 8.
...
**8.2.** O CONTROLADOR obriga-se a indenizar e manter a VETOR indene (incluindo custas, honorários e valores de acordos) por reclamações, sanções, autuações da ANPD ou condenações decorrentes de tratamento sem base legal, de instruções ilícitas, da origem irregular dos dados ou da conduta do CONTROLADOR.
...
**10.2.** A nulidade de uma cláusula não prejudica as demais. Aplica-se a legislação brasileira e o foro da Comarca de Bento Gonçalves/RS, ressalvada a competência legal própria do titular consumidor.
...
| Item | Descrição |
| --- | --- |
| Natureza e finalidade | Qualificação automatizada de leads por inteligência artificial, via WhatsApp, conforme instruções do Controlador. |
| Categorias de titulares | Leads do Controlador: pessoas que interagem com o número de WhatsApp por ele disponibilizado. |
| Categorias de dados | Nome, número de telefone/WhatsApp, conteúdo das mensagens trocadas e informações de qualificação fornecidas na conversa. |
| Dados sensíveis | Não previstos. O Controlador não deve inserir dados sensíveis na Automação sem base legal e medidas adequadas próprias. |
| Duração do tratamento | Pela vigência do contrato de prestação de serviços, salvo guarda legal obrigatória. |

_Nota: este documento está finalizado e pronto para uso. Recomenda-se revisão periódica por advogado(a) para manter a conformidade com eventuais atualizações legislativas e regulatórias, especialmente quanto à LGPD e às normas da ANPD._