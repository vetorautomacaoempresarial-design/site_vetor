...
**a)** Plataforma / Automação: solução de software baseada em inteligência artificial, de titularidade da VETOR, destinada à qualificação automatizada de leads por meio de troca de mensagens via WhatsApp.

**b)** WhatsApp Business / API: serviços de mensageria fornecidos por Meta Platforms, Inc. e suas afiliadas (“Meta”), de titularidade exclusiva de terceiros, dos quais a Automação depende para operar.

**c)** Lead: pessoa que entra em contato, ou é contatada, por meio do número de WhatsApp disponibilizado pelo CLIENTE e cujos dados são tratados pela Automação.
...
**3.2.** O CLIENTE reconhece que a Automação opera de forma integrada às plataformas da Meta e que seu funcionamento depende da disponibilidade, das regras, das políticas e das eventuais alterações técnicas impostas por esses terceiros, sobre os quais a VETOR não tem qualquer controle ou ingerência.
...
**5.2.** Disponibilizar e manter número de telefone válido e regularmente habilitado, arcando com todos os custos de linha, aparelho, internet e da conta de WhatsApp Business.

**5.3.** Cumprir integralmente os Termos de Serviço, as Políticas Comerciais e as demais regras da Meta/WhatsApp, bem como toda a legislação brasileira aplicável, em especial as normas de proteção de dados, consumo e telecomunicações.

**5.4.** Obter, de forma válida e prévia, todas as autorizações, consentimentos e bases legais necessárias para o contato e o tratamento dos dados dos Leads, na qualidade de controlador desses dados (Cláusula 12).

**5.5.** Não utilizar a Automação para finalidade ilícita, fraudulenta, enganosa ou que viole direitos de terceiros, respondendo de forma exclusiva por todo conteúdo, mensagem, oferta ou comunicação por ele configurada ou disparada.
...
**a)** praticar ou facilitar golpes, estelionato, phishing, pirâmides financeiras ou qualquer fraude;

**b)** enviar spam, mensagens em massa não solicitadas ou comunicações em desacordo com as regras da Meta;

**c)** tratar, divulgar ou disparar conteúdo ilícito, discriminatório, difamatório, violento, sexual envolvendo menores, ou que viole direitos autorais e de propriedade intelectual;

**d)** utilizar bases de contatos obtidas de forma ilícita ou sem base legal adequada;

**e)** realizar engenharia reversa, descompilação, cópia, sublicenciamento ou revenda da Automação.
...
**10.2.** A VETOR NÃO É RESPONSÁVEL, em nenhuma hipótese, por bloqueios, suspensões, banimentos, limitações, perda de verificação, redução de limites de envio, indisponibilidades ou quaisquer restrições impostas pela Meta/WhatsApp à conta, ao número ou ao perfil do CLIENTE, ainda que ocorram durante o uso da Automação.

**10.3.** O CLIENTE reconhece e concorda que tais medidas decorrem de decisão soberana e unilateral da Meta, frequentemente associadas à conduta do próprio usuário (volume e teor das mensagens, qualidade da base de contatos, denúncias de destinatários, histórico do número, entre outros fatores), assumindo de forma integral e exclusiva o risco de eventual banimento ou restrição.

**10.4.** A ocorrência de banimento, bloqueio ou restrição do número/conta do CLIENTE pela Meta NÃO configura defeito, falha ou inadimplemento da VETOR, NÃO suspende as obrigações do CLIENTE (inclusive de pagamento) e NÃO gera direito a reembolso, indenização, abatimento, compensação ou rescisão sem ônus.

**10.5.** A VETOR não garante a continuidade da integração com a Meta e poderá, a qualquer tempo e sem que isso configure descumprimento contratual, adaptar, limitar ou descontinuar funcionalidades em razão de alterações impostas por esses terceiros.
...
**11.2.** Observada a legislação aplicável, a responsabilidade total e acumulada da VETOR perante o CLIENTE, por qualquer causa, fica limitada ao valor efetivamente pago pelo CLIENTE nos 3 (três) meses imediatamente anteriores ao fato gerador.

**11.3.** A VETOR não se responsabiliza por: (i) atos, omissões, decisões, falhas ou indisponibilidades da Meta/WhatsApp e de quaisquer terceiros; (ii) uso indevido, ilícito ou negligente da Automação pelo CLIENTE; (iii) qualidade, origem ou licitude das bases de contatos e dos Leads; (iv) conteúdo das mensagens configuradas ou disparadas pelo CLIENTE; (v) interrupções decorrentes de caso fortuito ou força maior, falhas de energia, conexão, provedores ou ataques cibernéticos.
...
**12.2.** Quanto aos dados pessoais dos Leads tratados por meio da Automação, o CLIENTE atua como CONTROLADOR, sendo o único responsável por definir as finalidades, por dispor de base legal válida e por obter os consentimentos e autorizações necessários. A VETOR atua como OPERADORA, tratando tais dados estritamente conforme as instruções e a finalidade determinadas pelo CLIENTE e por este Contrato.

**12.3.** Quanto aos dados cadastrais do próprio CLIENTE, a VETOR atua como CONTROLADORA, nos termos de sua Política de Privacidade, que integra este Contrato.

**12.4.** O CLIENTE declara que possui base legal e autorizações adequadas para o tratamento dos dados dos Leads e responde, de forma exclusiva, perante os titulares e as autoridades por eventual ausência, invalidade ou insuficiência dessas bases.
...
**15.3.** Política de reembolso fora do prazo de arrependimento: **após o prazo de arrependimento de 7 (sete) dias, não há reembolso de período já iniciado. Para os planos Trimestral e Anual, a rescisão antecipada por iniciativa do CLIENTE implicará multa de 20% (vinte por cento) calculada sobre o saldo das parcelas mensais restantes até o término do período contratado, sem prejuízo das cobranças já vencidas. O CLIENTE mantém acesso ao Serviço até o término do período já pago**.

**15.4.** A VETOR poderá rescindir este Contrato, de pleno direito e sem ônus, em caso de violação pelo CLIENTE de qualquer cláusula, em especial as Cláusulas 5, 6 e 12, e nas hipóteses de inadimplência.
...
**17.2.** A eventual nulidade de uma cláusula não afeta as demais, que permanecerão válidas.

**17.3.** É vedada a cessão deste Contrato pelo CLIENTE sem anuência prévia e escrita da VETOR.
...
_Nota: este documento está finalizado e pronto para publicação e uso. Recomenda-se revisão periódica por advogado(a) para manter a conformidade com eventuais atualizações legislativas e regulatórias, especialmente nas cláusulas de limitação de responsabilidade e LGPD._